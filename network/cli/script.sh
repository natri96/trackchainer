...
CORE_PEER_MSPCONFIGPATH=/peers/ordererOrganizations/trackchainer.com/orderers/orderer.trackchainer.com/msp CORE_PEER_LOCALMSPID="OrdererMSP" peer channel create -o orderer.trackchainer.com:7050 -c default -f /peers/orderer/channel.tx --tls true --cafile /peers/orderer/localMspConfig/cacerts/ordererOrg.pem
